---
title: Lesson 3 - Creating plays
date: 2021-08-01 12:00:00 -500
...
{% include embed/youtube.html id='SDUMI-Q6PM0' %}
...
- name: Connect to access switches
  ...
  - name: Print Structured Data
    debug:
      msg: "{%raw%}{{ ios_output['stdout'][0] | clay584.genie.parse_genie(command='show vlan', os='ios')  }}{%endraw%}"
